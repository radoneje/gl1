...
int main( void )
{
    ...
    glm::mat4 Projection = glm::perspective(glm::radians(27.0f), 16.0f / 9.0f, 0.1f, 50.0f);
    // Camera matrix
    glm::mat4 View       = glm::lookAt(
            glm::vec3(0.225f,0,3), // Camera is at (4,3,3), in World Space
            glm::vec3(0.225f,0,0), // and looks at the origin
